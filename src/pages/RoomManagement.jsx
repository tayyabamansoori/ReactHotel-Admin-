        ...
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          <thead>
            <tr style={{ backgroundColor: "#333", color: "#fff", fontSize: "16px" }}>
              ...
              <th style={{ padding: "15px", borderBottom: "2px solid #555", textAlign: "left" }}>Type</th>
              <th style={{ padding: "15px", borderBottom: "2px solid #555", textAlign: "left" }}>Price</th>
          ...
          <tbody>
            <tr style={{ borderBottom: "1px solid #555", transition: "background-color 0.3s", ":hover": { backgroundColor: "#333" } }}>
              ...
              <td style={{ padding: "15px", color: "#fff" }}>Deluxe</td>
              <td style={{ padding: "15px", color: "#fff" }}>$200</td>
              <td style={{ padding: "15px", color: "#fff" }}>Available</td>
