        ...
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          ...
          <tbody>
            <tr style={{ borderBottom: "1px solid #555", transition: "background-color 0.3s", ":hover": { backgroundColor: "#333" } }}>
              <td style={{ padding: "15px", color: "#fff" }}>101</td>
              <td style={{ padding: "15px", color: "#fff" }}>John Doe</td>
              <td style={{ padding: "15px", color: "#fff" }}>101</td>
              <td style={{ padding: "15px", color: "#fff" }}>2023-10-01</td>
              <td style={{ padding: "15px", color: "#fff" }}>2023-10-05</td>
              <td style={{ padding: "15px", color: "#fff" }}>Confirmed</td>
              <td style={{ padding: "15px", display: "flex", gap: "10px" }}>
                ...
                <button style={{ padding: "10px 20px", backgroundColor: "#dc3545", color: "#fff", border: "none", borderRadius: "5px", cursor: "pointer", fontSize: "14px", transition: "background-color 0.3s", ":hover": { backgroundColor: "#c82333" } }}>Cancel</button>
              </td>
            </tr>
          </tbody>
        </table>
